...
class SARSA_Agent(BasicAgent):
    ...
    def __init__(self, env, eps=0.8, lr=0.1, gamma=0.8, num_episodes=20000):
    ...
    def evaluate(self):
        return np.max(self.episodes_reward)
...
# Наименование алгоритма
    ...
    def __init__(self, env, eps=0.1, lr=0.1, gamma=2, num_episodes=20000):
        # Вызов конструктора верхнего уровня
        super().__init__(env, eps)
        # Вторая матрица
...
#    def evaluate(self):
#        sum_rew = 0
#        for rew in self.episodes_reward:
#            sum_rew += sum_rew + rew
#        print(sum_rew)
