...
#CONST_ENV_NAME = 'CarRacing-v2'
#CONST_ENV_NAME = 'MountainCar-v0'
    ...
    def learn(self):
        ...
        for i_episode in range(num_episodes):
            ...
            for t in count():
                ...
                modified_reward = reward + 10 * abs(observation[1])
...
#                self.memory.push(state, action, next_state, reward)
                self.memory.push(state, action, next_state, modified_reward)
